 ...
 * </p>
 * <ul>
 *   <li>{@link StateMachine.impl.Xmod_ElementImpl#getXmod_id <em>Xmod id</em>}</li>
 * </ul>
 *
 * @generated NOT
 */
public abstract class Xmod_ElementImpl extends MinimalEObjectImpl.Container implements Xmod_Element {
	...
	protected EClass eStaticClass() {
		return StateMachinePackage.Literals.XMOD_ELEMENT;
	}
	...
	public void setXmod_id(String newXmod_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachinePackage.XMOD_ELEMENT__XMOD_ID, oldXmod_id,
					xmod_id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case StateMachinePackage.XMOD_ELEMENT__XMOD_ID:
			return getXmod_id();
		}
