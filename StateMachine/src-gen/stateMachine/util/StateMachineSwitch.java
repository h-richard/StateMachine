...
public class StateMachineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case StateMachinePackage.STATE_MACHINE: {
			...
			if (result == null)
				result = caseCompositeState(stateMachine);
			if (result == null)
				result = caseState(stateMachine);
			if (result == null)
		...
		case StateMachinePackage.COMPOSITE_STATE: {
			...
			if (result == null)
				result = caseState(compositeState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case StateMachinePackage.PSEUDO_STATE: {
			PseudoState pseudoState = (PseudoState) theEObject;
			T result = casePseudoState(pseudoState);
			if (result == null)
				result = caseState(pseudoState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case StateMachinePackage.HISTORY_STATE: {
			...
			if (result == null)
				result = casePseudoState(historyState);
			if (result == null)
				result = caseState(historyState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case StateMachinePackage.XMOD_ELEMENT: {
