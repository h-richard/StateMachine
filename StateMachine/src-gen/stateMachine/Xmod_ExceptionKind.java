 ...
 * <!-- end-user-doc -->
 * @see StateMachine.StateMachinePackage#getXmod_ExceptionKind()
 * @model
 * @generated NOT
 */
public enum Xmod_ExceptionKind implements Enumerator {
	...
	*/
	 ...
	 * @generated NOT
	 */
	private static final Xmod_ExceptionKind[] VALUES_ARRAY = new Xmod_ExceptionKind[] { OK, UNKNOWN_NAMESPACE,
			OBJECT_NOT_FOUND, METHOD_NOT_FOUND, PARAMETERS_NOT_MATCHING, RETURN_TYPE_NOT_MATCHING, METHOD_EXCEPTION,
			OTHER, };
	...
	public static Xmod_ExceptionKind get(int value) {
		...
		case OK_VALUE:
			return OK;
		case UNKNOWN_NAMESPACE_VALUE:
			return UNKNOWN_NAMESPACE;
		case OBJECT_NOT_FOUND_VALUE:
			return OBJECT_NOT_FOUND;
		case METHOD_NOT_FOUND_VALUE:
			return METHOD_NOT_FOUND;
		case PARAMETERS_NOT_MATCHING_VALUE:
			return PARAMETERS_NOT_MATCHING;
		case RETURN_TYPE_NOT_MATCHING_VALUE:
			return RETURN_TYPE_NOT_MATCHING;
		case METHOD_EXCEPTION_VALUE:
